...
public isolated function convertToSpreadsheetProperties(json jsonProperties) returns SpreadsheetProperties {
...
public isolated function convertToInt(string stringVal) returns int {
    if (stringVal != "") {
